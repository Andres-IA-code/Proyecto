...
interface OperadorQuoteLimitModalProps {
  isOpen: boolean;
  onClose: () => void;
  quotesUsed: number;
  quotesLimit: number;
...
const OperadorQuoteLimitModal: React.FC<OperadorQuoteLimitModalProps> = ({
  isOpen,
  onClose,
  quotesUsed,
  quotesLimit,
        ...
        <div className="p-6">
          ...
          <div className="mb-6">
            <p className="text-gray-600 mb-4">
              Has enviado <strong>{quotesUsed} de {quotesLimit}</strong> cotizaciones disponibles en tu plan gratuito.
            </p>
            <p className="text-gray-600">
              Para continuar enviando cotizaciones, necesitas actualizar tu suscripción a un plan premium.
            </p>
          </div>
...
export default OperadorQuoteLimitModal;