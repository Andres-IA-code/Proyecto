  ...
  return (
    <div className="space-y-8">
      <div>
        ...
        <p className="text-gray-600 mt-2">Panel de Control - Dador de Carga</p>
      </div>
        ...
        <div className="bg-white p-6 rounded-xl shadow-sm border border-gray-100">
          <div className="flex items-center justify-between">
            <div>
              ...
              <p className="text-3xl font-bold text-gray-900 mt-2">{stats.totalEnvios}</p>
            </div>
        ...
        <div className="bg-white p-6 rounded-xl shadow-sm border border-gray-100">
          <div className="flex items-center justify-between">
            <div>
              ...
              <p className="text-3xl font-bold text-indigo-600 mt-2">{stats.enCotizacion}</p>
            </div>
        ...
        <div className="bg-white p-6 rounded-xl shadow-sm border border-gray-100">
          <div className="flex items-center justify-between">
            <div>
              ...
              <p className="text-3xl font-bold text-amber-600 mt-2">{stats.enProgreso}</p>
            </div>
      ...
      <div className="bg-white rounded-xl shadow-sm border border-gray-100 p-6">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
          ...
          >
            ...
            <h3 className="font-semibold text-gray-900">Crear Nuevo Envío</h3>
            <p className="text-sm text-gray-600 mt-1">Publica una nueva carga para cotizar</p>
          </Link>
          ...
          >
            ...
            <h3 className="font-semibold text-gray-900">Ver Cotizaciones</h3>
            <p className="text-sm text-gray-600 mt-1">Revisa las ofertas recibidas</p>
          </Link>
        </div>
      </div>
    </div>
